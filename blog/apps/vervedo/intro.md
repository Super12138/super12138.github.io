...
一个简约的、遵循 Material 3 Expressive 的待办应用，使用 Jetpack Compose 编写

当前语言版本：**简体中文**

For English user, [click here to read English version](https://github.com/Super12138/VerveDo/blob/main/README_EN.md)
...
# ⬇️ 下载
:::tip
下方两个渠道是官方认定的安全渠道，请从这两个渠道下载 VerveDo 以保证个人隐私不被侵犯

VerveDo 不会自动更新，建议[订阅 GitHub Release 发行通知](https://docs.github.com/zh/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/configuring-notifications#configuring-your-watch-settings-for-an-individual-repository)或者[安装 F-Droid](https://f-droid.org/) 检查更新
:::

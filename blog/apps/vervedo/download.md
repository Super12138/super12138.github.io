...
# 下载
VerveDo **仅支持 `Android` 系统**。对全架构均支持。
...
## Android <Badge type="tip" text="3.4.0" />
- [在 GitHub Release 上下载](https://github.com/Super12138/VerveDo/releases/)

VerveDo 也上架了 F-Droid，你可以[安装 F-Droid](https://f-droid.org/) 来安装 VerveDo 并获得统一的更新体验。

- [从 F-Droid 上下载](https://f-droid.org/packages/cn.super12138.todo)

## CI
[前往 Github Actions](https://github.com/Super12138/VerveDo/actions/workflows/android_ci.yml)

VerveDo也提供由 `Github Actions` 在每次提交后的在线构建版本。它包含了 VerveDo 的最新功能。会覆盖安装在 `Github Release` 发布的正式版 VerveDo。
:::danger
该操作**无法撤回**，请根据自身需求下载体验。

如遇问题，可在 [GitHub Issues](https://github.com/Super12138/VerveDo/issues) 上反馈，并写清是 CI 版。
:::